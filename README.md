...
Para funcionar, NÃO esqueça de configurar no código o SEU acesso ao Banco de Dados MySQL e / ou MSSQL Server dentro do arquivo "App.config", caso você tenha usuário e senha, por exemplo. O Banco MongoDB está no caminho default.
...
- MS SQL Server - RDBMS (Banco de Dados Relacional) - Porém será usado como se fosse um BD de Documentos, NÃO tem o TIPO de campo "JSON", a recomendação da Microsoft é usar "nvarchar(max)".
...
Dicas de como usar JSON dentro do MS SQL Server:
...
https://learn.microsoft.com/pt-br/sql/t-sql/functions/json-value-transact-sql?view=sql-server-ver16
...
https://learn.microsoft.com/pt-br/sql/relational-databases/json/format-query-results-as-json-with-for-json-sql-server?view=sql-server-ver16
...
https://learn.microsoft.com/pt-br/sql/t-sql/functions/json-path-exists-transact-sql?view=sql-server-ver16
